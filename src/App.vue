    ...
    <div>
      <md-stepper md-vertical>
        ...
        <md-step md-label="Select Firmware File" :md-continue="this.firmware !== null">
          ...
          <p>If you need a firmware file, go to <a href="https://feel-technologies.com/firmware/">https://feel-technologies.com/firmware/</a> and
            download the firmware for your toy using the links listed there</p>
          <md-input-container>
            <md-file
              accept="*"
